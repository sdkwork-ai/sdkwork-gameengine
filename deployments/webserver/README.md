...
Module `sdkwork-gameengine` · runtime code `gameengine` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `gameengine-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `gameengine-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `gameengine-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `gameengine-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `gameengine.sdkwork.com` | 443 ssl + 80 |
