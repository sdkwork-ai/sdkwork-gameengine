...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `gameengine-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `gameengine-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `gameengine-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `gameengine.sdkwork.com` | 443 ssl + 80 |
