# Runbook — sdkwork-gameengine deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-gameengine-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-gameengine/bundle`, loads the image, starts
